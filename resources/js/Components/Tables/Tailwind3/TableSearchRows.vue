<template>
  <div
    class="w-full bg-gray-200 p-4 mb-4 rounded mt-4"
      ...
      <div class="flex-grow space-y-4">
        <div v-for="(search, key) in enabledFilters" :key="key" class="h-8 flex items-center">
          <div class="flex-grow relative">
            <input
              class="block w-full sm:text-sm border-gray-300 focus:border-gray-300 focus:ring focus:border-gray-500
            ...
            <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
              <button
                ...
                class="rounded-md text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
              >
